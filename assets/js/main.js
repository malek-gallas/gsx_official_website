...
// Function to open the modal and initialize the YouTube video player
function openModal(videoUrl) {
  document.getElementById("videoModal").style.display = "flex";
  player = new YT.Player("player", {
    height: "100%",
    width: "100%",
    videoId: getVideoId(videoUrl), // Extract the video ID from the URL
    playerVars: {
...
function getVideoId(url) {
  var match = url.match(/(?:youtu\.be\/|youtube\.com(?:\/embed\/|\/v\/|\/watch\?v=|\/user\/\S+|\/ytscreeningroom\?v=))([\w-]{11})/)
